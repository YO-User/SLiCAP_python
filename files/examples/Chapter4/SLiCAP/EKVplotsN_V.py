...
fig_Ids_Vgs_Log = plotSweep('IdsVgsLog', '$I_{ds}(V_{gs})$', result, 0.01, 1.8, 50, axisType = 'semilogy', sweepVar= 'V_G', xUnits = 'V', yVar = 'I_DS_X1', yScale = 'u', yUnits = 'A', funcType = 'param', show = True)
fig2html(fig_Ids_Vgs_Log, 600)
...
traces2fig(LTspiceTraces, fig_Ids_Vgs_Log)
fig_Ids_Vgs.plot()
