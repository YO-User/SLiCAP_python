#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File CDstageCompensationBulk.py

from SLiCAP import *
fileName = 'CDcompM18bulk'
...
fig2html(fig_as_gain_model_mag, 600)
...
fig2html(fig_as_gain_model_phs, 600)
...
figRL = plotPZ(fileName + '_rootLocus', 'CD stage', polesResult, xmin=-1e9, xmax = 0, ymin=-0.5e9, ymax=0.5e9, show=True)
fig2html(figRL, 600)
